        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="flex gap-2">
                    <Button
                        variant={ activeAccordion === 'advanced-filter' ? 'default' : "outline"}
                        className="h-12"
                        onClick={() => {
                            if (activeAccordion === 'advanced-filter') {
                                setQueryParams('active-accordion', '');
                                // searchParams.delete('active-accordion');
                                return;
                            }
                            
                            setQueryParams('active-accordion', 'advanced-filter');
            ...
            {/* Advanced Filters */}
            <Accordion data-testid="accordion" type="single" collapsible value={activeAccordion} className="mb-6">
                <AccordionItem value="advanced-filter" className='pt-4'>
                    {/* <AccordionTrigger>Advanced Filters</AccordionTrigger> */}
                    <AccordionContent>
                        <div className="bg-white rounded-lg w-full h-full p-6 shadow-sm border">
