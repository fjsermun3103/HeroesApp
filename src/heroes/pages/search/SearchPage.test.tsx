...
describe('SearchPage', () => {
    ...
    test('should call search action with name paramenter', () => {
    ...
    test('should call search action with strength paramenter', () => {
    ...
    test('should call search action with name and strength paramenters', () => {
